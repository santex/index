...
def clean_args(args: list) -> list:
    ...
    for arg in args:
        if " " in arg:
            arg = '"' + arg + '"'
        clean_args_.append(arg.replace("__COLON__", ":"))
...
def deprecated(func):
    ...
    def deprecated_fun(*args, **kwargs):
        warnings.warn('The {} method is deprecated and will be removed in a future release'.format(
