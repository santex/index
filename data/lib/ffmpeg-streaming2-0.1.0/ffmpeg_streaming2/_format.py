...
class H264(Format):
    def __init__(self, video: str = "libx264", audio: str = 'aac', **codec_options):
        ...
        audios = ['copy', 'aac', 'libvo_aacenc',
                  'libfaac', 'libmp3lame', 'libfdk_aac']

        super(H264, self).__init__(_verify_codecs(video, videos),
                                   _verify_codecs(audio, audios), **codec_options)
...
class HEVC(Format):
    ...
    def __init__(self, video: str = "libx265", audio: str = 'aac', **codec_options):
        ...
        super(HEVC, self).__init__(_verify_codecs(video, videos),
                                   _verify_codecs(audio, audios), **codec_options)
...
class VP9(Format):
    ...
    def __init__(self, video: str = "libvpx-vp9", audio: str = 'aac', **codec_options):
        ...
        super(VP9, self).__init__(_verify_codecs(video, videos),
                                  _verify_codecs(audio, audios), **codec_options)
